...
def main():
    ...
    We recommend that you never delete `task.md` file. Instead, when
    you want to solve a different task, simply change the content of
    task.md file and then run `acoder solve` again.
