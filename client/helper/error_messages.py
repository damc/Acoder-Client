...
2. Do the task by yourself.""",
    'Output too long': """The cumulative length of the files that you have included and the changes generated by Acoder is too long. Acoder can execute only simple/small tasks. If you want Acoder to do something big, you have to divide it into smaller tasks.
    
What you can do now - possible options:
1. Include less files below 'Change' or 'Look'.
2. Make the task simpler/smaller. For example, instead of having a task: "make an entire website", have a task "make a "registration page" and then another task "make a log in page" and so on.
